...
def CheeseThread():
    def handle():
        ...
        new_trans2 = cheese.new_trans('Satoshi team', 'UJM', 200)
        miner2 = 'Anh'
        trans_col_list = cheese.collect_trans(my_cheeses.processed_trans_list, new_trans2, miner2)
        new_mined_json1 = cheese.cheese_mining(my_cheeses.stack, trans_col_list)
        my_cheeses.stack.append(new_mined_json1)

        new_trans3 = cheese.new_trans('Satoshi team', 'UJM', 200)
        miner2 = 'Anh'
        trans_col_list = cheese.collect_trans(my_cheeses.processed_trans_list, new_trans3, miner2)
        new_mined_json1 = cheese.cheese_mining(my_cheeses.stack, trans_col_list)
        my_cheeses.stack.append(new_mined_json1)
